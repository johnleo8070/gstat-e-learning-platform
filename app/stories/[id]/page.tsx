        ...
        <div className="min-h-screen bg-background flex flex-col">
            ...
            <main className="flex-1 flex flex-col items-center justify-center p-4 pb-32">
                <div className="max-w-2xl w-full">
                    {/* Character and Professor Whiskers */}
                    <div className="flex justify-center items-end gap-4 mb-6">
                        <div className="text-6xl animate-bounce">{story.character}</div>
                        <div className="flex flex-col items-center gap-2">
                          {/* Speech Bubble */}
                          {pandaMessage && (
                            <div className="relative bg-white border-2 border-border rounded-2xl px-4 py-3 max-w-xs shadow-md text-sm text-foreground font-medium">
                              {pandaMessage}
                              <div className="absolute bottom-[-10px] left-6 w-4 h-4 bg-white border-r-2 border-b-2 border-border rotate-45" />
                            </div>
                          )}
